...
You can find your tinkergame.log from the last execution in `/dev/shm/tinkergame/tinkergame.log`.
If you ran a command to check the version, this will overwrite the previous log, so please ensure that you are attaching the log created directly after running TinkerGame and reproducing your issue.
