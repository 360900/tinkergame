...
function listAllSettingsEntries {
	if [ -f "$STLSETENTRIES" ]; then
		...
		done <<< "$(sed -n "/^#STARTSETENTRIES/,/^#ENDSETENTRIES/p;/^#ENDSETENTRIES/q" "$TGSRC_SETENTRIES" | grep "\--field")"
	fi
}
...
--field="     $GUI_USETABBEDMENU!$DESC_USETABBEDMENU ('USETABBEDMENU')":CHK "${USETABBEDMENU/#-/ -}" `#CAT_Gui` `#SUB_Checkbox` `#MENU_GLOBAL` \
--field="     $GUI_YADTHEME!$DESC_YADTHEME ('YADTHEME')" "${YADTHEME/#-/ -}" `#CAT_Gui` `#MENU_GLOBAL` \
--field="     $GUI_YADCSS!$DESC_YADCSS ('YADCSS')":FL "${YADCSS/#-/ -}" `#CAT_Gui` `#MENU_GLOBAL` \
...
--field="     $GUI_VORTEXARGS!$DESC_VORTEXARGS ('VORTEXARGS')" "${VORTEXARGS/#-/ -}" `#CAT_Vortex` `#MENU_GLOBAL` \
--field="     $GUI_VORTEXNODECORATION!$DESC_VORTEXNODECORATION ('VORTEXNODECORATION')":CHK "${VORTEXNODECORATION/#-/ -}" `#CAT_Vortex` `#MENU_GLOBAL` \
